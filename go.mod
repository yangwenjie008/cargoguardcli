...
// Force compatible Docker version for oras.land/oras-go
replace github.com/docker/docker => github.com/docker/docker v24.0.9+incompatible

// Force compatible distribution version
replace github.com/docker/distribution => github.com/docker/distribution v2.8.2+incompatible

// Force compatible docker/cli version
replace github.com/docker/cli => github.com/docker/cli v24.0.9+incompatible
